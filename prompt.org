...
For each of the org file in Library, correct the spelling and the grammar, write the
corrected content in a code block, preserve the Org Mode markup.
...
#+begin_src bash
for file in $(fd -t f -g '*.org' ./library); do
  echo "<content file=$file>"
  cat "$file"
  echo "</content>"
  echo ""
