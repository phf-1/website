...
#+begin_abstract
A approximaition of the actor model implementated in JavaScript is introduced despite
...
local reasoning through runtime invariant checks, and typed immutable
messages. Actors processes messages sequentially, supports fire-and-forget pub/sub
signals, without shared mutable state. The actor system powering this page serves as
