...
handle the next message[cite:@hewitt1977lawsA]. An actor system is a collection of
actors that interact exclusively through asynchronous message passing, without shared
mutable state or explicit locks. Actor systems are computationally universal: they
can perform any effective (Turing-computable) computation and, due to unbounded
nondeterminism, express behaviors beyond Turing
